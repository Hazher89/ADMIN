          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/help" className="hover:text-white transition-colors">Funksjoner</Link></li>
                <li><Link href="/help" className="hover:text-white transition-colors">Priser</Link></li>
                <li><Link href="/help" className="hover:text-white transition-colors">Integrasjoner</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/help" className="hover:text-white transition-colors">Dokumentasjon</Link></li>
                <li><Link href="/help" className="hover:text-white transition-colors">Kontakt</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/help" className="hover:text-white transition-colors">Om oss</Link></li>
                <li><Link href="/help" className="hover:text-white transition-colors">Karriere</Link></li>
                <li><Link href="/help" className="hover:text-white transition-colors">Personvern</Link></li>
              </ul>
            </div>
          </div>
