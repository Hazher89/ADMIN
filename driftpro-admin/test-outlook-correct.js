...
async function testOutlookCorrect() {
  console.log('🔍 Testing with correct Outlook SMTP settings...\n');
  ...
  try {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 2rem; background: white;">
            ...
            <p style="color: #666; line-height: 1.6;">
              Din Outlook SMTP-konfigurasjon er nå aktivert og fungerer perfekt!
            </p>
    ...
    console.log('🎉 Outlook SMTP connection test completed successfully!');
    console.log('💡 You can now use these credentials in the DriftPro admin panel.');
    
  } catch (error) {
    console.error('❌ Error testing Outlook SMTP connection:');
    ...
    if (error.code === 'EAUTH') {
      ...
      console.error('   - Check if smtp-mail.outlook.com is accessible');
