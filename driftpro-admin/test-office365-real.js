...
async function testOffice365Connection() {
  ...
  // Replace these with your actual Office 365 credentials
  const email = 'driftpro@mavilogistikk.no'; // Your Office 365 email
  const password = 'YourOffice365Password'; // Your Office 365 password
