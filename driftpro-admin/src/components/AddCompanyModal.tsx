...
const sidebarPermissions: SidebarPermission[] = [
  ...
  { id: 'absence', name: 'Fravær', href: '/dashboard/absence', icon: <Clock size={16} />, category: 'main', enabled: false },
{ id: 'vacation', name: 'Ferie', href: '/dashboard/vacation', icon: <Heart size={16} />, category: 'main', enabled: false },
