  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="lg:hidden bg-gray-800 border-b border-gray-700 p-4 flex items-center justify-between">
        ...
        <h1 className="text-white font-bold">Advanced Planning</h1>
      ...
      <div className="flex">
        ...
        <div className={`
          ...
          ${mobileMenuOpen ? 'fixed inset-y-0 left-0 z-50 w-80' : 'hidden lg:flex'}
        ...
        `}>
          ...
          {!sidebarCollapsed && (
            <div className="p-4 border-t border-gray-700">
              <Link
                href="/dashboard"
                className="w-full flex items-center px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-colors"
              >
                ← Back to Dashboard
              </Link>
            </div>
